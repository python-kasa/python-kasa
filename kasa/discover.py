...
class Discover:
    ...
    async def discover(
        *,
        ...
        If you have multiple interfaces, please be sure that you specify as target the broadcast address of the network 
        where your devices lives. 
        ...
        :param target: The target broadcast address of the interface youre devices lives on (e.g. 192.168.xxx.255).
